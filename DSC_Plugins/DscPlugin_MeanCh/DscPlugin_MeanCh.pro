...
TEMPLATE     = lib
TARGET       = dscplugin_meanch
CONFIG      += plugin

DEFINES     += DSCPLUGIN_MEANCH_LIBRARY
VERSION     += 1.0.0
...
install_it.files += libdscplugin_meanch.cfg
INSTALLS += install_it
...
SOURCES +=  src/dscplugin_meanch.cpp


HEADERS +=  include/dscplugin_meanch.h \
