...
public:
    ...
    Model(QStringList* listImageFileNames, QObject *parent = 0);
    ~Model();
    ...
    void setListOfImages(QStringList* newImageFileList);
    void refreshListOfImages();

    //
    QStringList* listImageFileNames;
